...
//
// Code generated for Simulink model 'ros_controller2'.
//
// Model version                  : 1.4
// Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
// C/C++ source code generated on : Fri Nov 15 14:17:11 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"ros_controller2\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(ros_controller2_M, (NULL));
        ros_controller2_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(ros_controller2_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(ros_controller2_M)
                == (NULL)) || rtmGetStopRequested(ros_controller2_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(ros_controller2_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
